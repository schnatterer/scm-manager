...
Props > {
  ...
  handleRealmDescriptionChange = (value
:
string
)
=
...
;
handleEnableRepositoryArchiveChange = (value
:
boolean
)
=
...
;
handleDisableGroupingGridChange = (value
:
boolean
)
=
...
;
handleAnonymousAccessEnabledChange = (value
:
string
)
=
...
handleSkipFailedAuthenticatorsChange = (value
:
string
)
=
...
handleEnabledXsrfProtectionChange = (value
:
boolean
)
=
...
;
handleDefaultNamespaceStrategyChange = (value
:
string
)
=
