...
Props > {
  render() {
    ...
    return (
      < div >
      < Subtitle
    subtitle = {t("proxy-settings.name"
  )
  }
    />
    < Checkbox
    ...
    type = "password"
    disabled = {
    !enableProxy || !hasUpdatePermission
  }
    />
    < InputField
  ...
  handleProxyPasswordChange = (value
:
string
)
=
...
addProxyExclude = (proxyExcludeName
:
string
)
=
...
isProxyExcludeMember = (proxyExcludeName
:
string
)
=
